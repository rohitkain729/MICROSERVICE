...
import com.app.clientcomp.VendorServiceClientComp;
...
public class ShoppingServiceController {
	...
	@Autowired
	private VendorServiceClientComp vendorClient;
	...
	@GetMapping("/vendor")
	public ResponseEntity<List<Vendor>> vendorShoppingData() {
...
//		double amt = new Random().nextInt(400000);
		...
		// invole provide MS
		List<Vendor> response = vendorClient.getAllProduct();
